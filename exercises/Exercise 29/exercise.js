 ...
 * @param {StringList} colours CSS-style colour list for gradient
 ...
 */
function plotDottedLine(data, colours, triangles, svg=null, labels=[]) {
    ...
    let grad = d3.scaleLinear().domain([d3.min(data, (d) => d.y), d3.max(data, (d) => d.y)]).range(colours);
